...
import { handleStateForPlayerTrack } from "../../db/stopBeginTrack";
import {
  useGlobalAppDispatch,
  useGlobalAppSelector,
} from "../../redux/hooks/globalHook";
import { handleSetTracksToDefault } from "../../db/resetAllTracks";
...
export const Player = () => {
  ...
  return (
    <>
      <main
        className={`fixed  bg-[rgb(48,48,48)] w-[100%] z-[1000] h-[2.25rem] flex flex-col justify-center align-center place-self-center z-[1000] left-0 bottom-0 `}
      >
