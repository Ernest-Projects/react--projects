...
export const ArtistTools = () => {
  ...
  return (
    <>
      <motion.section data-cy = "artist-tools"
        transition={{ duration: 0.1 }}
        className="h-fit w-[100%]   relative "
      >
        <button data-cy = "artist-tools-button" onClick={() => setIsToolsOpened(prev => !prev)} className="w-[100%] h-fit relative flex flex-cols justify-between pb-6 ">
