...
import {Likes} from "../library-sections/index"
 const LikesPage = () => {
return (<>
<motion.main initial = {{y: -10, opacity: 0}} animate = {{y: 0, opacity: 1}} className="border border-red-500 flex flex-col  w-full h-fit gap-y-[1.5rem]" data-cy = "likes">
                <header className="text-white font-semibold"> LIKES</header>
