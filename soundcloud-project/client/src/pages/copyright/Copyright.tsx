...
export const Copyright = () => {
  ...
  return (
    <>
      <motion.main data-cy = "copyright"
        initial={{ opacity: 0, y: -10 }}
        animate={{ opacity: 1, y: 0 }}
        className="relative pt-2 z-[100] w-[100%] mb-[2rem] h-fit grid grid-row-1 grid-cols-7"
      >
        ...
        <section className="w-[100%] h-fit col-span-2 sticky top-12 px-2">
          <div className=" bg-[rgb(48,48,48)] px-4 py-1 pb-4 top-0 w-full h-fit place-self-center">
            <header className={`${refHeaderStyles} text-md font-semobold`}>
