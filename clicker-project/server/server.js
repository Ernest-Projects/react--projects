...
import { CREATE_TABLE, DELETE_ROW, DROP_TABLE, INSERT_ROW, SELECT_ALL, SELECT_BY_ID, UPDATE_BY_ID } from "./actions.js";
...
//     try {
//         const res = pool.query(CREATE_TABLE)
//     }catch(err) {
//         console.error(err)
//     }
// }
...
// const deleteRowsById = async (from, to) => {
//     for(let index = from; index <= to; index++) {
//         try {
//             const del = await pool.query(DELETE_ROW, [index])
//         }catch(err)  {
//             console.error(err);
//         }
//     }
...
// deleteRowsById(from, to).then(res => {
//     console.log("Elements in row deleted from ", from, " to ", to)
//     // res.status(200)
// }).catch(err =>{
//     console.error(err)
//     // res.status(404)
