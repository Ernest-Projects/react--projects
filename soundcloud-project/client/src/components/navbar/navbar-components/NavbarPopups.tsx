  ...
  return (
    <>
      <motion.div
        ...
        initial={{ opacity: 0, y: 0 }}
        animate={{ opacity: 1, y: 10 }}
        className={` top-[100%] w-[10rem] h-fit py-2 rounded-[.1rem] bg-[rgb(18,18,18)] font-medium right-[.2rem] text-md border-[rgb(50,50,50)] border-[0.2px] absolute aspect-[1/1] px-2  text-white`}
      >
